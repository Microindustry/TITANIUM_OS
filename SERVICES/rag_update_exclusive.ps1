...
# Rebuild RAG in ACCESSO ESCLUSIVO a ChromaDB: ferma watchdog+api (che tengono
...
Write-Host "== 1) fermo watchdog + api (accesso esclusivo a ChromaDB) ==" -ForegroundColor Cyan
...
Write-Host "== 4) riavvio api (logfile = handle validi) + watchdog ==" -ForegroundColor Cyan
