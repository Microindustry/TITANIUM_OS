...
- Tariffa oraria: **€45/h**
- Posizionamento: tra artigiano (€15-25/h) e fresatura CNC professionale (€80-120/h)
- Vantaggio: qualità CNC, flessibilità prototipale, tempi rapidi

## MIMS — Unit Economics (scenario fusione)

| Voce | Valore |
|------|--------|
| Costo produzione unitario | €2.50 |
| Prezzo vendita target | €12.00 |
| Margine lordo | €9.50 (79%) |
| Break-even stampo (€15.000) | 1.578 pezzi |
| Dal pezzo 1.579 | rendita operativa pura |

## Gerarchia Prezzi Connettori MIMS

| Livello | Nome | Prezzo |
|---------|------|--------|
| Entry | MIMS Junior/Light (Eco-Snap) | €9.90 (pacco) |
| Mid | MIMS Maker/Pro-Twist | €3.50 cad |
| Pro | MIMS Heavy/Industrial (Tech-Bolt) | €45.00+ |

## Leva Finanziaria

- Prezzo vendita / Costo produzione: **4.8x**
- Per ogni €1 nel ciclo → €4.80 restituiti
