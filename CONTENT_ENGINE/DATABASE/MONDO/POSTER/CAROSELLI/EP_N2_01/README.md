...
**Stato:** ✅ esportato in Adobe Express (25/06/2026)
...
| `slides/` | Export PNG delle 8 slide (da generare: Chrome headless o download da Express) |

## Le 8 slide
1. **Copertina** — la porta + ponte Atomi|Bit + titolo
2. **Il Pizzicore** — cold open, "una domanda di troppo"
3. **L'Ingresso** — la porticina non vista, l'aprì
4. **Atomi ↔ Bit** — la Giuntura, "sono lo stesso mondo"
5. **La Prova** — i due bottoni, "tira"
6. **La Verità** — "fatto bene = regge quando lo tiri"
7. **La Superpotenza** — chiedere perché + provare con le mani
8. **Casella 2 →** — open loop verso la misura + CTA
