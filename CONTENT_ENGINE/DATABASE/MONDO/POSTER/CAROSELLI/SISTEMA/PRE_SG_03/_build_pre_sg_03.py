...
S = [
    ...
    dict(social=True, scene="notte", kicker="I GUASTI",
         ...
         intro='La volta che il sistema è rimasto muto per dieci notti — e nessuno se n\'era accorto. La volta che la memoria si è riempita da sola, fino a scoppiare. <span class="soft">Li leggerete senza trucco</span>: con la diagnosi e la cura.'),
    ...
    dict(social=True, scene="mappa", kicker="IL PROSSIMO PASSO",
         lead='E adesso che vi fidate…<br><span class="cyan">cosa</span> vi racconto?',
         intro='Un viaggio in sei tappe, dal giorno zero al capannone. Nell\'ultimo capitolo del preambolo: la mappa.',
         cta='SEGUI IL SISTEMA · ultimo capitolo: «La mappa delle stagioni» → salva il carosello'),
