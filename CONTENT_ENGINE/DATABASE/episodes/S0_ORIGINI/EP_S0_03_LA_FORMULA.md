...
**Tono:** Il numero che cambia la prospettiva — quasi brutale nella chiarezza
**Personaggi attivi:** Matteo (voce), AVA (grafici finanziari), THEMIS (verdetti economici)
**Fonte:** MANIFESTO_CODEX.md + SCIENZA_FINANZIARIA.md
...
*[Grafico: asse X = pezzi venduti. Asse Y = profitto. La curva sale lentamente fino a 1.578. Poi piega verso l'alto.]*
...
Da una parte: il mondo Maker. Profili in alluminio leggeri, flessibili, modulari. Costosi per quello che sono, fragili per quello che promettono. Montano, smontano, si deformano sotto carico.
...
Chi vuole costruire strutture solide — banchi, macchine, palestre, isole di lavoro — è costretto a scegliere tra la fragilità del Maker e l'investimento impossibile dell'Industriale.

*[AVA: mappa del mercato con gap evidenziato.]*
...
Questa frase — scritta per rispondere alla domanda degli investitori — è più precisa di qualsiasi spec tecnica. Perché definisce non cosa vendi, ma *a chi manca* quello che vendi.

---

## ATTO II — LA MATEMATICA DELL'ABBONDANZA

*[AVA mostra l'equazione. Semplice. Brutale.]*
...
*[AVA: confronto grafico additive vs fusione. Tempo, materiale, costo.]*

Questa non è ottimizzazione. È cambio di paradigma produttivo.
...
Non è un ostacolo. È il prezzo della durata — acciaio temperato HRC 50+, lavorato con elettroerosione, certificato per 100.000+ cicli senza manutenzione. €15.000 garantisce un'infrastruttura produttiva che dura anni.

*[Calcolo sullo schermo: 15.000 ÷ 9,50 = 1.578]*

**1.578 pezzi.**

I primi 1.578 pezzi ripagano lo stampo. Dal pezzo 1.579 in poi: ogni ciclo della macchina genera €9,50 di profitto puro. Non margine — profitto. Lo stampo è già pagato.
...
*[AVA mostra la curva: lenta fino a 1.578, poi verticale.]*

Il grafico ha un gomito. Prima del gomito lavori per pagare l'investimento. Dopo il gomito l'investimento lavora per te.

Il sistema è progettato per arrivare a quel gomito il più velocemente possibile. La V32 produce lo stampo. Lo stampo produce i pezzi. I pezzi generano il margine. Il margine finanzia l'upgrade della V32.

Il ciclo amplificante parte dal gomito.

---

## ATTO IV — L'ASIMMETRIA

C'è un concetto che vale più dei numeri.
...
Il cliente non compra una macchina. Compra l'accesso a una capacità produttiva che prima era riservata alle grandi industrie. Noi forniamo il corpo indistruttibile. Lui ci mette il cervello.

---

## CHIUSURA

*[Un foglio. Due colonne. Sinistra: cosa hai. Destra: cosa vale.]*
...
La risposta era nei numeri. 79% di margine. 1.578 pezzi al break-even. ROI 322% in anno 1. Asset €11.749 con €2.250 di investimento.

Ma la risposta vera era nella struttura. Non stavi chiedendo soldi per un'idea. Stavi mostrando un sistema già in esecuzione — verificato con foto e calibro il 13 Febbraio 2026, approvato su tre assi, con un componente da €2.800 già in casa che valeva più dell'intero investimento richiesto.

Non chiedi fiducia. Mostri prove.

E le prove sono: una piastra fresata H7, quattro molle gialle che non oscillano, un numero sul display del comparatore.
...
> *Ponte → EP_00 (Stagione 1):*
> La STAGIONE 0 è la preistoria.
> Tre file RPG. Un organismo unificato. Una verifica con calibro. Una formula finanziaria.
> Adesso inizia la costruzione.
> Adesso inizia la storia che puoi toccare.
>
> *"Questo non è un video su come costruire una CNC.*
> *È un video su come leggere la propria storia al contrario."*

*Continua in EP_00 — Origine (Stagione 1)*

---

*Ricorsioni:*
- *"79% margine su hardware" → eco EP_03 (meta-ricorsività) e EP_05 (marketplace MIMS con revenue sharing)*
