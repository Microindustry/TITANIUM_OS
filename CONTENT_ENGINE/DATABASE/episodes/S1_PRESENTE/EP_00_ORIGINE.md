...
**Formato:** Video-podcast | Durata stimata: 12-15 min
**Tono:** Confessionale, diretto, zero retorica
**Personaggi attivi:** Matteo (voce), AVA (narrazione grafica off-screen)
**Fonte:** ASSOLUTO V6 — Atto I §1.2, §1.3
...
*Immagine: mani. Non quelle di un influencer — mani con cicatrici da TIG, unghie corte, calli nei punti giusti. Tengono un calibro digitale. Sul display: 0.008 mm.*
...
*[AVA appare con una mappa visuale — ogni azienda come nodo, frecce che collegano le competenze]*
...
*[Mani che appoggiano il calibro sul banco. Sullo sfondo, la struttura in acciaio 40x40 saldata TIG del basamento.]*
