      ...
      children: [
...

        {
          ...
          children: [
            ...
            crit("au20", "STORIE: ~20 episodi su disco non nella dashboard", "active",
              "RECUPERO VISIBILITÀ Opus (vedi STORIE_INDEX.md): 6 narrativi S2 (EP_S2_00..05: IL DISTACCO, CERVELLO IBRIDO, ORCHESTRATORE, LA TELA, IL CV, IL SILENZIO) + 5 MOMENTI (MOM_01..05) esistono come .md ma NON in storieData.ts. Codici stagione incrociati (disco S2_SISTEMA ↔ storieData ST). Serve sync_storie.py guidato (no import cieco → miscategorizza). Nulla perso, tutto su disco."),
